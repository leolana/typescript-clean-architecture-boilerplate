...
export class MovieController {
  ...
  public constructor(@inject(TYPE.MovieRepository) movieRepository: Repository<Movie>) {
  ...
  @httpGet('/:year')
  public async getByYear(@response() res: express.Response, @requestParam('year') yearParam: string) {
    try {
