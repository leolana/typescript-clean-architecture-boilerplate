...
module.exports = {
  scripts: {
    ...
    copy: {
      ...
      swagger: {
        script: copy('./src/infrastructure/api/swagger.json', './dist/src'),
        hiddenFromHelp: true,
      },
      public: {
        script: copyDir('./src/infrastructure/public', './dist/src/infrastructure/public'),
        hiddenFromHelp: true,
      },
      tmp: {
    ...
    db: {
      ...
      setup: {
        script: series('cross-env NODE_ENV=development', 'nps db.drop', 'nps db.migrate', 'nps db.seed'),
